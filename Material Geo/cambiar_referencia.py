...
referencia_espacial_destino.ImportFromEPSG(3035)

#Preparamos el fichero /de destino/nuevo/a crear/
fichero_destino = "shp/referencia_cambiada.shp"
...
capa_destino = data_source_destino.CreateLayer(capa_origen.GetName(),referencia_espacial_destino)
